...
exports.book_create_post = [
	...
	body('isbn', 'ISBN must not be empty').isLength({ min: 10 }).trim(),
  ...
  async.parallel({
      ...
      .exec(callback);
		...
		if (results.book==null) { // No results.
			...
			res.render('book_delete', { title: 'Delete book(books not empty)', book: results.book, book_instances: results.book_instance } );
		}
    else {
      // Book has no bookInstances. Delete object and redirect to the list.
